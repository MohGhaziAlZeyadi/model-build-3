...
def get_pipeline(
    ...
    step_process = ProcessingStep(
        name="Data-Preprocessing-Step01",
        step_args=step_args,
    )
    ...
    step_higher_mse_send_email_lambda = LambdaStep(
        name="Send-Email-To-NeuronTeam-Step4-3",
    ...
    step_lower_mse_deploy_model_lambda = LambdaStep(
        name="Deploy-Model-To-Endpoint-Step4-2-1",
    ...
    step_cond = ConditionStep(
        name="Check-Accuracy-If-Greater-Than-Given-Threshold-Step04",
        conditions=[cond_lte],
